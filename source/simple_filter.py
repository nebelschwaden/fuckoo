...
for report in result:
	...
	#Include an 'i' counter to stop when certain number of reports have been processed.
...
#For the Goodware, Locker, Encryptor (G,L,E) etiquette, we can retrieve the first char of the corresponding directory.
#For the Artfifact ID, we can write the current Artifact Folder Name and then make a group by function
#Informe del filtrado de datos
#Bitácora de tiempo de procesamiento de distinta cantidad de reportes